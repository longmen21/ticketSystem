...
<?php
session_start ();
if (isset ( $_SESSION ["admin"] ) && $_SESSION ["admin"] == true &&($_SESSION['role'])== 2) {
	// echo "您已经成功登陆";
} else {
...
<body>
	...
	<div style="height: 100px;">
		...
		<div style="font-size: 36px; font-style: inherit; float: left;">问题待审核列表</div>
	</div>
	<center>
		<div style="width: 1000px;">
			<table class="table table-hover">
				...
				<tbody>
					...
					$query = "SELECT b.id,b.title,b.time_submit,b.t_type,a.name FROM users a,ticket b WHERE a.userid = b.userid AND t_status = 1";
					...
					<tr>
						...
						<td style="padding-top: 4px;">
							<a href="dataSrvGet.php?request=accept&ticketid=<?php echo $row['id']?>&operate=1"><button type="button" class="btn btn-success  btn-sm">通过</button></a>
							<a href="dataSrvGet.php?request=accept&ticketid=<?php echo $row['id']?>&operate=0"><button type="button" class="btn btn-danger  btn-sm">拒绝</button></a>
						</td>
					</tr>
				<?php
					}
